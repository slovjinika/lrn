...
def load_words(file_path="speech.json"):
...
def main():
    ...
    parser.add_argument("--data", default="speech.json", help="Path to the JSON file with data.")
    ...
    while True:
        ...
        if not word:
            print("Game over. All words have been learned.")
